...
namespace LongDucProject.Controllers
{
    public class Project3Controller : Controller
    {
        ...
        public ActionResult Inverter1()
        {
            ...
            {
                return View("Inverter1", "~/Views/Shared/_LayoutProject3.cshtml");
            }
            //return View("Inverter1", "~/Views/Shared/_LayoutProject3.cshtml");
        }
        public ActionResult Inverter2()
        {
            ...
            {
                return View("Inverter2", "~/Views/Shared/_LayoutProject3.cshtml");
            }
            //return View("Inverter2", "~/Views/Shared/_LayoutProject3.cshtml");
        }
        public ActionResult Inverter3()
        {
            ...
            {
                return View("Inverter3", "~/Views/Shared/_LayoutProject3.cshtml");
            }
            //return View("Inverter3", "~/Views/Shared/_LayoutProject3.cshtml");
        }
        public ActionResult Inverter4()
        {
            ...
            {
                return View("Inverter4", "~/Views/Shared/_LayoutProject3.cshtml");
            }
            //return View("Inverter4", "~/Views/Shared/_LayoutProject3.cshtml");
        }
        public ActionResult Inverter5()
        {
            ...
            {
                return View("Inverter5", "~/Views/Shared/_LayoutProject3.cshtml");
            }
        ...
        public ActionResult Inverter6()
        {
            ...
            {
                return View("Inverter6", "~/Views/Shared/_LayoutProject3.cshtml");
            }
            //return View("Inverter6", "~/Views/Shared/_LayoutProject3.cshtml");
        }
        public ActionResult Inverter7()
        {
            ...
            {
                return View("Inverter7", "~/Views/Shared/_LayoutProject3.cshtml");
            }
            //return View("Inverter7", "~/Views/Shared/_LayoutProject3.cshtml");
        }
        public ActionResult Inverter8()
        {
            ...
            {
                return View("Inverter8", "~/Views/Shared/_LayoutProject3.cshtml");
            }
            //return View("Inverter8", "~/Views/Shared/_LayoutProject3.cshtml");
        }
        public ActionResult Info()
        {
            ...
            {
                return View("Info", "~/Views/Shared/_LayoutProject3.cshtml");
            }
            //return View("Info", "~/Views/Shared/_LayoutProject3.cshtml");
        ...
        public ActionResult Alarm()
        {
            ...
            {
                return View("Alarm", "~/Views/Shared/_LayoutProject3.cshtml");
            }
            //return View("Alarm", "~/Views/Shared/_LayoutProject3.cshtml");
        }
        public ActionResult Event()
        {
            ...
            {
                return View("Event", "~/Views/Shared/_LayoutProject3.cshtml");
            }
            //return View("Event", "~/Views/Shared/_LayoutProject3.cshtml");
        ...
        public ActionResult Weather()
        {
            ...
            {
                return View("Weather", "~/Views/Shared/_LayoutProject3.cshtml");
            }
            //return View("Weather", "~/Views/Shared/_LayoutProject3.cshtml");
        }
        public ActionResult Signage3()
        {
            if (Session["Role"] is null) return RedirectToAction("Login", "Home");

            if ((int)Session["Role"] == (int)Role.Admin || (int)Session["Role"] == (int)Role.SolEnergy || (int)Session["Role"] == (int)Role.JGC || (int)Session["Role"] == (int)Role.Hino)
            {
                return View("Signage3", "~/Views/Shared/_LayoutSignageAdmin.cshtml");
            }
            else if ((int)Session["Role"] == (int)Role.LDIP)
            {
                return View("Signage3", "~/Views/Shared/_LayoutLDIP.cshtml");
            }
            else
            {
                return View("Signage3", "~/Views/Shared/_LayoutProject3.cshtml");
            }
            // return View("Signage3", "~/Views/Shared/_LayoutProject3.cshtml");
        }
        ...
        public ActionResult UserSettings()
        {
            ...
            {
                return View("UserSettings", "~/Views/Shared/_LayoutProject3.cshtml");
            }
            //return View("UserSettings", "~/Views/Shared/_LayoutProject3.cshtml");
        }
    }
