...
{
    public class Project5Controller : Controller
    {
        // GET: Project5
        public ActionResult Inverter1()
        {
            ...
            {
                return View("Inverter1", "~/Views/Shared/_LayoutProject5.cshtml");
            }
        }
        public ActionResult Inverter2()
        {
            ...
            {
                return View("Inverter2", "~/Views/Shared/_LayoutProject5.cshtml");
            }
        }
        public ActionResult Inverter3()
        {
            ...
            {
                return View("Inverter3", "~/Views/Shared/_LayoutProject5.cshtml");
            }
        }
        public ActionResult Inverter4()
        {
            ...
            {
                return View("Inverter4", "~/Views/Shared/_LayoutProject5.cshtml");
            }
        }
        ...
        public ActionResult Info()
        {
            ...
            {
                return View("Info", "~/Views/Shared/_LayoutProject5.cshtml");
            }
            //return View("Info", "~/Views/Shared/_LayoutProject5.cshtml");
        ...
        public ActionResult Alarm()
        {
            ...
            {
                return View("Alarm", "~/Views/Shared/_LayoutProject5.cshtml");
            }
        }
        public ActionResult Event()
        {
            ...
            {
                return View("Event", "~/Views/Shared/_LayoutProject5.cshtml");
            }
        ...
        public ActionResult Weather()
        {
            ...
            {
                return View("Weather", "~/Views/Shared/_LayoutProject5.cshtml");
            }
        }
        public ActionResult Signage5()
        {
            if (Session["Role"] is null) return RedirectToAction("Login", "Home");

            if ((int)Session["Role"] == (int)Role.Admin || (int)Session["Role"] == (int)Role.SolEnergy || (int)Session["Role"] == (int)Role.JGC || (int)Session["Role"] == (int)Role.Hino)
            {
                return View("Signage5", "~/Views/Shared/_LayoutSignageAdmin.cshtml");
            }
            else if ((int)Session["Role"] == (int)Role.LDIP)
            {
                return View("Signage5", "~/Views/Shared/_LayoutLDIP.cshtml");
            }
            else
            {
                return View("Signage5", "~/Views/Shared/_LayoutProject5.cshtml");
            }
        ...
        public ActionResult UserSettings()
        {
            ...
            {
                return View("UserSettings", "~/Views/Shared/_LayoutProject5.cshtml");
            }
        }
    }
}