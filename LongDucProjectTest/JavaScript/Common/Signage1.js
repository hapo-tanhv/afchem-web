...
function updateChart(data) {
    ...
    if (!charttotal) {
        ...
        Highcharts.chart('container', {
            ...
            plotOptions: {
                column: {
                    stacking: null // Loại bỏ stacking để các cột không bị chồng lên nhau
                }
            },
            series: [{
                name: 'Solar Energy',
        ...
        // Cập nhật dữ liệu nếu biểu đồ đã tồn tại
