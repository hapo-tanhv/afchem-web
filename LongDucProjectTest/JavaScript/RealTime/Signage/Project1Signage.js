...
document.addEventListener("DOMContentLoaded", function () {
    ...
    dataCollection.add(`ITNProject1Common.DailyCO2`);
    dataCollection.add(`ITNProject1Common.MonthlyCO2`);
    dataCollection.add(`ITNProject1Common.YearlyCO2`);
    dataCollection.add(`ITNProject1Common.CO2Reduce`);
    ...
    updateTag2(
        dataCollection.get(`ITNProject1Common.DailyCO2`),
        document.querySelector('#DailyCO2'));
    updateTag3(
        dataCollection.get(`ITNProject1Common.MonthlyCO2`),
        document.querySelector('#MonthlyCO2'));
    updateTag4(
        dataCollection.get(`ITNProject1Common.YearlyCO2`),
        document.querySelector('#YearlyCO2'));
    updateTag5(
        dataCollection.get(`ITNProject1Common.CO2Reduce`),
