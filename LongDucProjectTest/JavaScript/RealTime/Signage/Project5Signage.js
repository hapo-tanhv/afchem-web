document.addEventListener("DOMContentLoaded", function () {
    ...
    dataCollection.add(`ITNProject5Common.SelfConsumption`);
    dataCollection.add(`ITNProject5Common.PurchasedPower`);
    dataCollection.add(`ITNProject5Common.ExcessPower`);

    dataCollection.add(`ITNProject5Energy.DailySelfConsumption`);
    dataCollection.add(`ITNProject5Energy.MonthlySelfConsumption`);
    dataCollection.add(`ITNProject5Energy.YearlySelfConsumption`);
    dataCollection.add(`ITNProject5Energy.SelfConsumption`);

    dataCollection.add(`ITNProject5Common.DailyCO2`);
    dataCollection.add(`ITNProject5Common.MonthlyCO2`);
    dataCollection.add(`ITNProject5Common.YearlyCO2`);
    dataCollection.add(`ITNProject5Common.CO2Reduce`);
    ...
    updateTag2(
        dataCollection.get(`ITNProject5Common.SelfConsumption`),
    ...
    updateTag5(
        dataCollection.get(`ITNProject5Energy.DailySelfConsumption`),
        document.querySelector('#DailySelf'));
    updateTag6(
        dataCollection.get(`ITNProject5Energy.MonthlySelfConsumption`),
        document.querySelector('#MonthlySelf'));
    updateTag7(
        dataCollection.get(`ITNProject5Energy.YearlySelfConsumption`),
        document.querySelector('#YearlySelf'));
    updateTag8(
        dataCollection.get(`ITNProject5Energy.SelfConsumption`),
        document.querySelector('#TotalSelf'));

    updateTag9(
        dataCollection.get(`ITNProject5Common.DailyCO2`),
        document.querySelector('#DailyCO2'));
    updateTag10(
        dataCollection.get(`ITNProject5Common.MonthlyCO2`),
        document.querySelector('#MonthlyCO2'));
    updateTag11(
        dataCollection.get(`ITNProject5Common.YearlyCO2`),
        document.querySelector('#YearlyCO2'));
    updateTag12(
        dataCollection.get(`ITNProject5Common.CO2Reduce`),
