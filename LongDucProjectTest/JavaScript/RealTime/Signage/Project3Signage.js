document.addEventListener("DOMContentLoaded", function () {
    ...
    dataCollection.add(`Project3SolarPowerMeter.ActivePower`);
    dataCollection.add(`Project3ExistingPowerMeter.TotalPurchasedEnergy`);
    dataCollection.add(`Project3ExistingPowerMeter.TotalSurplusEnergy`)
    ...
    dataCollection.add(`ITNProject3Energy.SelfConsumption`);

    dataCollection.add(`ITNProject3Common.DailyCO2`);
    dataCollection.add(`ITNProject3Common.MonthlyCO2`);
    dataCollection.add(`ITNProject3Common.YearlyCO2`);
    dataCollection.add(`ITNProject3Common.CO2Reduce`);
    ...
    updateTag3(
        dataCollection.get(`Project3ExistingPowerMeter.TotalPurchasedEnergy`),
        document.querySelector('#PurchasedPower'));
    updateTag4(
        dataCollection.get(`Project3ExistingPowerMeter.TotalSurplusEnergy`),
    ...
    updateTag8(
        dataCollection.get(`ITNProject3Energy.SelfConsumption`),
        document.querySelector('#TotalSelf'));

    updateTag9(
        dataCollection.get(`ITNProject3Common.DailyCO2`),
        document.querySelector('#DailyCO2'));
    updateTag10(
        dataCollection.get(`ITNProject3Common.MonthlyCO2`),
        document.querySelector('#MonthlyCO2'));
    updateTag11(
        dataCollection.get(`ITNProject3Common.YearlyCO2`),
        document.querySelector('#YearlyCO2'));
    updateTag12(
        dataCollection.get(`ITNProject3Common.CO2Reduce`),
