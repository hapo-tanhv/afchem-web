document.addEventListener("DOMContentLoaded", function () {
    ...
    dataCollection.add(`WetherStationPR4.AmbientTemp`);
    dataCollection.add(`WetherStationPR4.Irradiation`);
    dataCollection.add(`WetherStationPR4.PVmoduleTemp1`);
    dataCollection.add(`WetherStationPR4.PVmoduleTemp2`);

    updateTag1(
        dataCollection.get(`WetherStationPR4.AmbientTemp`),
        document.querySelector('#AmbientAirTemperature'));
    updateTag2(
        dataCollection.get(`WetherStationPR4.Irradiation`),
        document.querySelector('#Irradiance'));
    updateTag3(
        dataCollection.get(`WetherStationPR4.PVmoduleTemp1`),
        document.querySelector('#BackOfModuleTemperature1'));
    updateTag4(
        dataCollection.get(`WetherStationPR4.PVmoduleTemp2`),
