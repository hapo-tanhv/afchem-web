document.addEventListener("DOMContentLoaded", function () {
    ...
    dataCollection.add(`WetherStationPR6.AmbientTemp`);
    dataCollection.add(`WetherStationPR6.Irradiation`);
    dataCollection.add(`WetherStationPR6.PVmoduleTemp1`);
    dataCollection.add(`WetherStationPR6.PVmoduleTemp2`);

    updateTag1(
        dataCollection.get(`WetherStationPR6.AmbientTemp`),
        document.querySelector('#AmbientAirTemperature'));
    updateTag2(
        dataCollection.get(`WetherStationPR6.Irradiation`),
        document.querySelector('#Irradiance'));
    updateTag3(
        dataCollection.get(`WetherStationPR6.PVmoduleTemp1`),
        document.querySelector('#BackOfModuleTemperature1'));
    updateTag4(
        dataCollection.get(`WetherStationPR6.PVmoduleTemp2`),
