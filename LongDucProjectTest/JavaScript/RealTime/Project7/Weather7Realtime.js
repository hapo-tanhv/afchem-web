document.addEventListener("DOMContentLoaded", function () {
    ...
    dataCollection.add(`WetherStationPR7.AmbientTemp`);
    dataCollection.add(`WetherStationPR7.Irradiation`);
    dataCollection.add(`WetherStationPR7.PVmoduleTemp1`);
    dataCollection.add(`WetherStationPR7.PVmoduleTemp2`);

    updateTag1(
        dataCollection.get(`WetherStationPR7.AmbientTemp`),
        document.querySelector('#AmbientAirTemperature'));
    updateTag2(
        dataCollection.get(`WetherStationPR7.Irradiation`),
        document.querySelector('#Irradiance'));
    updateTag3(
        dataCollection.get(`WetherStationPR7.PVmoduleTemp1`),
        document.querySelector('#BackOfModuleTemperature1'));
    updateTag4(
        dataCollection.get(`WetherStationPR7.PVmoduleTemp2`),
