document.addEventListener("DOMContentLoaded", function () {
    ...
    dataCollection.add(`WetherStationRF1.PVmoduleTemp1`);
    dataCollection.add(`WetherStationRF1.PVmoduleTemp2`);
    ...
    updateTag3(
        dataCollection.get(`WetherStationRF1.PVmoduleTemp1`),
        document.querySelector('#BackOfModuleTemperature1'));
    updateTag4(
        dataCollection.get(`WetherStationRF1.PVmoduleTemp2`),
