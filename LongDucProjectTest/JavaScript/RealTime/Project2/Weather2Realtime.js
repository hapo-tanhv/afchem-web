document.addEventListener("DOMContentLoaded", function () {
    ...
    dataCollection.add(`WetherStationRF3.AmbientTemp`);
    dataCollection.add(`WetherStationRF3.Irradiation`);
    dataCollection.add(`WetherStationRF3.PVmoduleTemp1`);
    dataCollection.add(`WetherStationRF3.PVmoduleTemp2`);

    updateTag1(
        dataCollection.get(`WetherStationRF3.AmbientTemp`),
        document.querySelector('#AmbientAirTemperature'));
    updateTag2(
        dataCollection.get(`WetherStationRF3.Irradiation`),
        document.querySelector('#Irradiance'));
    updateTag3(
        dataCollection.get(`WetherStationRF3.PVmoduleTemp1`),
        document.querySelector('#BackOfModuleTemperature1'));
    updateTag4(
        dataCollection.get(`WetherStationRF3.PVmoduleTemp2`),
