...
python3 packages/spec/src/claude/skills/ui-ux-pro-max/scripts/search.py "immersive 3d" --domain style
python3 packages/spec/src/claude/skills/ui-ux-pro-max/scripts/search.py "animation" --domain ux
```
