   ...
   public class ProjectCommonParameter
    {
        ...
        public float SolarPeak { get; set; }
        public float SolarOffPeak { get; set; }
        public float SolarNormal { get; set; }
        public float GridPeakIM { get; set; }
        public float GridOffPeakIM { get; set; }
        public float GridNormalIM { get; set; }
        public float GridPeakEX { get; set; }
        public float GridOffPeakEX { get; set; }
        public float GridNormalEX { get; set; }
    }
}
